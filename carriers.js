...
async function ResolvePromise(cityD, cityA, dd, ad, c ,p) {
    try {
        ...
        console.log("Dopo await price ", price.data.Itineraries[0].PricingOptions[0].Price);
        console.log("Dopo await price ", price.data.Carriers[0].Name);
        console.log("Dopo await price ", price.data.Carriers[0].ImageUrl);
...
main("Mil", "Sto", "2019-03-03", "2019-03-10", "economy", "1");